...
class ConfigApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_config_type_endpoint = _Endpoint(
            settings={
                'response_type': (CreateEnvelope,),
                'auth': [
                    'ztSession',
                ...
                'endpoint_path': '/config-types',
                'operation_id': 'create_config_type',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_config_type_endpoint = _Endpoint(
            settings={
                'response_type': (Empty,),
                'auth': [
                    'ztSession',
                ...
                'endpoint_path': '/config-types/{id}',
                'operation_id': 'delete_config_type',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.detail_config_endpoint = _Endpoint(
            settings={
                'response_type': (DetailConfigEnvelope,),
                'auth': [
                    'ztSession',
                    'oauth2'
                ],
                'endpoint_path': '/configs/{id}',
                'operation_id': 'detail_config',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.detail_config_type_endpoint = _Endpoint(
            settings={
                'response_type': (DetailConfigTypeEnvelope,),
                'auth': [
                    'ztSession',
                    'oauth2'
                ],
                'endpoint_path': '/config-types/{id}',
                'operation_id': 'detail_config_type',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_config_services_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/configs/{id}/services',
                'operation_id': 'list_config_services',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_config_types_endpoint = _Endpoint(
            settings={
                'response_type': (ListConfigTypesEnvelope,),
                'auth': [
                    'ztSession',
                    'oauth2'
                ],
                'endpoint_path': '/config-types',
                'operation_id': 'list_config_types',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_configs_endpoint = _Endpoint(
            settings={
        ...
        self.list_configs_for_config_type_endpoint = _Endpoint(
            settings={
                'response_type': (ListConfigsEnvelope,),
                'auth': [
                    'ztSession',
                ...
                'endpoint_path': '/config-types/{id}/configs',
                'operation_id': 'list_configs_for_config_type',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_config_endpoint = _Endpoint(
            settings={
                'response_type': (Empty,),
                'auth': [
                    'ztSession',
        ...
        self.patch_config_type_endpoint = _Endpoint(
            settings={
                'response_type': (Empty,),
                'auth': [
                    'ztSession',
                ...
                'endpoint_path': '/config-types/{id}',
                'operation_id': 'patch_config_type',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.update_config_type_endpoint = _Endpoint(
            settings={
                'response_type': (Empty,),
                'auth': [
                    'ztSession',
                ...
                'endpoint_path': '/config-types/{id}',
                'operation_id': 'update_config_type',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def create_config(
        ...
        **kwargs
        ...
        Args:
            config (ConfigCreate): A config to create
    ...
    def create_config_type(
        ...
        **kwargs
        ...
        Args:
            config_type (ConfigTypeCreate): A config-type to create
        ...
        kwargs['config_type'] = \
            config_type
        return self.create_config_type_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_config_type(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.delete_config_type_endpoint.call_with_http_info(**kwargs)
    ...
    def detail_config(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.detail_config_endpoint.call_with_http_info(**kwargs)
    ...
    def detail_config_type(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.detail_config_type_endpoint.call_with_http_info(**kwargs)
    ...
    def list_config_services(
        ...
        **kwargs
        ...
        """List services referenced by a config  # noqa: E501

        Retrieves a list of service resources that reference a given config; supports filtering, sorting, and pagination. Requires admin access.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_config_services(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.list_config_services_endpoint.call_with_http_info(**kwargs)
    ...
    def list_config_types(
        ...
        **kwargs
        ...
        >>> thread = api.list_config_types(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_config_types_endpoint.call_with_http_info(**kwargs)
    ...
    def list_configs(
        ...
        **kwargs
        ...
        >>> thread = api.list_configs(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.list_configs_endpoint.call_with_http_info(**kwargs)
    ...
    def list_configs_for_config_type(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.list_configs_for_config_type_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_config(
        ...
        **kwargs
        ...
        Args:
            id (str): The id of the requested resource
            config (ConfigPatch): A config patch object
        ...
        kwargs['config'] = \
            config
        return self.patch_config_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_config_type(
        ...
        **kwargs
        ...
        Args:
            id (str): The id of the requested resource
            config_type (ConfigTypePatch): A config-type patch object
        ...
        kwargs['config_type'] = \
            config_type
        return self.patch_config_type_endpoint.call_with_http_info(**kwargs)
    ...
    def update_config(
        ...
        **kwargs
        ...
        Args:
            id (str): The id of the requested resource
            config (ConfigUpdate): A config update object
    ...
    def update_config_type(
        ...
        **kwargs
        ...
        Args:
            id (str): The id of the requested resource
            config_type (ConfigTypeUpdate): A config-type update object
        ...
        kwargs['config_type'] = \
            config_type
        return self.update_config_type_endpoint.call_with_http_info(**kwargs)
