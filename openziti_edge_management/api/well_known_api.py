...
class WellKnownApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_well_known_cas_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/.well-known/est/cacerts',
                'operation_id': 'list_well_known_cas',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_well_known_cas(
        ...
        **kwargs
        ...
        return self.list_well_known_cas_endpoint.call_with_http_info(**kwargs)
