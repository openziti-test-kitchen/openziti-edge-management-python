...
class CurrentIdentityApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_current_identity_endpoint = _Endpoint(
            settings={
                'response_type': (CurrentIdentityDetailEnvelope,),
                'auth': [
                    'ztSession',
                    'oauth2'
                ],
                'endpoint_path': '/current-identity',
    ...
    def get_current_identity(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_current_identity_endpoint.call_with_http_info(**kwargs)
