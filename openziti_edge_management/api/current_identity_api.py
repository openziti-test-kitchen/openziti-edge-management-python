...
class CurrentIdentityApi(object):
    ...
    @validate_arguments
    def get_current_identity(self, **kwargs) -> CurrentIdentityDetailEnvelope:  # noqa: E501
        """Return the current identity  # noqa: E501

        Returns the identity associated with the API sessions used to issue the current request  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_current_identity(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: CurrentIdentityDetailEnvelope
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_current_identity_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_current_identity_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_current_identity_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Return the current identity  # noqa: E501
        ...
        >>> thread = api.get_current_identity_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(CurrentIdentityDetailEnvelope, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_current_identity" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "CurrentIdentityDetailEnvelope",
            '401': "ApiErrorEnvelope",
        }
