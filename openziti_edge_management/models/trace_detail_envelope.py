...
class TraceDetailEnvelope(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TraceDetailEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TraceDetailEnvelope:
        """Create an instance of TraceDetailEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TraceDetailEnvelope.parse_obj(obj)

        _obj = TraceDetailEnvelope.parse_obj({
            "data": TraceDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
