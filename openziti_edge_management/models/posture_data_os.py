...
class PostureDataOs(BaseModel):
    ...
    __properties = ["lastUpdatedAt", "postureCheckId", "timedOut", "build", "type", "version"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureDataOs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureDataOs:
        """Create an instance of PostureDataOs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureDataOs.parse_obj(obj)

        _obj = PostureDataOs.parse_obj({
