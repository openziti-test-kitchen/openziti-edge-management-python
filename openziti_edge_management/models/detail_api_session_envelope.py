...
class DetailApiSessionEnvelope(BaseModel):
    """
    DetailApiSessionEnvelope
    """
    data: ApiSessionDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailApiSessionEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailApiSessionEnvelope:
        """Create an instance of DetailApiSessionEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailApiSessionEnvelope.parse_obj(obj)

        _obj = DetailApiSessionEnvelope.parse_obj({
            "data": ApiSessionDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
