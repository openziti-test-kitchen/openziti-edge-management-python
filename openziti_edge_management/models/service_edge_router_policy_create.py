...
class ServiceEdgeRouterPolicyCreate(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceEdgeRouterPolicyCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceEdgeRouterPolicyCreate:
        """Create an instance of ServiceEdgeRouterPolicyCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceEdgeRouterPolicyCreate.parse_obj(obj)

        _obj = ServiceEdgeRouterPolicyCreate.parse_obj({
