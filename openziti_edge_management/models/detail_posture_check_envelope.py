...
class DetailPostureCheckEnvelope(BaseModel):
    """
    DetailPostureCheckEnvelope
    """
    data: PostureCheckDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailPostureCheckEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailPostureCheckEnvelope:
        """Create an instance of DetailPostureCheckEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailPostureCheckEnvelope.parse_obj(obj)

        _obj = DetailPostureCheckEnvelope.parse_obj({
            "data": PostureCheckDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
