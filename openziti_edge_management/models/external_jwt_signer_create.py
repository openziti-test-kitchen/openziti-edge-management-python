...
class ExternalJwtSignerCreate(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalJwtSignerCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalJwtSignerCreate:
        """Create an instance of ExternalJwtSignerCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalJwtSignerCreate.parse_obj(obj)

        _obj = ExternalJwtSignerCreate.parse_obj({
