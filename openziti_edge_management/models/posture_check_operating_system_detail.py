...
class PostureCheckOperatingSystemDetail(PostureCheckDetail):
    """
    PostureCheckOperatingSystemDetail
    """
    operating_systems: conlist(OperatingSystem) = Field(..., alias="operatingSystems")
    __properties = ["_links", "createdAt", "id", "name", "roleAttributes", "tags", "typeId", "updatedAt", "version", "operatingSystems"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckOperatingSystemDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckOperatingSystemDetail:
        """Create an instance of PostureCheckOperatingSystemDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckOperatingSystemDetail.parse_obj(obj)

        _obj = PostureCheckOperatingSystemDetail.parse_obj({
            "links": dict(
