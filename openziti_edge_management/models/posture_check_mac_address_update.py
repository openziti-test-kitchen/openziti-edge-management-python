...
class PostureCheckMacAddressUpdate(PostureCheckUpdate):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckMacAddressUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckMacAddressUpdate:
        """Create an instance of PostureCheckMacAddressUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckMacAddressUpdate.parse_obj(obj)

        _obj = PostureCheckMacAddressUpdate.parse_obj({
            "name": obj.get("name"),
