...
class IdentityUpdate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityUpdate:
        """Create an instance of IdentityUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentityUpdate.parse_obj(obj)

        _obj = IdentityUpdate.parse_obj({
