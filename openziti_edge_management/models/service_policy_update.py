...
class ServicePolicyUpdate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServicePolicyUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServicePolicyUpdate:
        """Create an instance of ServicePolicyUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServicePolicyUpdate.parse_obj(obj)

        _obj = ServicePolicyUpdate.parse_obj({
