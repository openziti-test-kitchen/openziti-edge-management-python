...
class DetailCaEnvelope(BaseModel):
    """
    DetailCaEnvelope
    """
    data: CaDetail = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailCaEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailCaEnvelope:
        """Create an instance of DetailCaEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailCaEnvelope.parse_obj(obj)

        _obj = DetailCaEnvelope.parse_obj({
            "data": CaDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
