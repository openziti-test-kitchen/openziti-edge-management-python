...
class ListServiceConfigsEnvelope(BaseModel):
    """
    ListServiceConfigsEnvelope
    """
    data: conlist(ServiceConfigDetail) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListServiceConfigsEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListServiceConfigsEnvelope:
        """Create an instance of ListServiceConfigsEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListServiceConfigsEnvelope.parse_obj(obj)

        _obj = ListServiceConfigsEnvelope.parse_obj({
            "data": [ServiceConfigDetail.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
