...
class PostureDataEndpointState(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureDataEndpointState:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureDataEndpointState:
        """Create an instance of PostureDataEndpointState from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureDataEndpointState.parse_obj(obj)

        _obj = PostureDataEndpointState.parse_obj({
