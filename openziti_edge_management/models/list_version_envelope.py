...
class ListVersionEnvelope(BaseModel):
    """
    ListVersionEnvelope
    """
    data: Version = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListVersionEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListVersionEnvelope:
        """Create an instance of ListVersionEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListVersionEnvelope.parse_obj(obj)

        _obj = ListVersionEnvelope.parse_obj({
            "data": Version.from_dict(obj.get("data")) if obj.get("data") is not None else None,
