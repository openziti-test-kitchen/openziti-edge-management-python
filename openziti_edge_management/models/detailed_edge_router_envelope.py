...
class DetailedEdgeRouterEnvelope(BaseModel):
    """
    DetailedEdgeRouterEnvelope
    """
    data: EdgeRouterDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailedEdgeRouterEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailedEdgeRouterEnvelope:
        """Create an instance of DetailedEdgeRouterEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailedEdgeRouterEnvelope.parse_obj(obj)

        _obj = DetailedEdgeRouterEnvelope.parse_obj({
            "data": EdgeRouterDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
