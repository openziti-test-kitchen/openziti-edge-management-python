...
class ServiceConfigAssign(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceConfigAssign:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceConfigAssign:
        """Create an instance of ServiceConfigAssign from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceConfigAssign.parse_obj(obj)

        _obj = ServiceConfigAssign.parse_obj({
