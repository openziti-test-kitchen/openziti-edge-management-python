...
class IdentityExtendEnrollmentEnvelope(BaseModel):
    """
    IdentityExtendEnrollmentEnvelope
    """
    data: Optional[IdentityExtendCerts] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityExtendEnrollmentEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityExtendEnrollmentEnvelope:
        """Create an instance of IdentityExtendEnrollmentEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentityExtendEnrollmentEnvelope.parse_obj(obj)

        _obj = IdentityExtendEnrollmentEnvelope.parse_obj({
            "data": IdentityExtendCerts.from_dict(obj.get("data")) if obj.get("data") is not None else None,
