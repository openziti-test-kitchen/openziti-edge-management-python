...
class ServicePolicyCreate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServicePolicyCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServicePolicyCreate:
        """Create an instance of ServicePolicyCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServicePolicyCreate.parse_obj(obj)

        _obj = ServicePolicyCreate.parse_obj({
