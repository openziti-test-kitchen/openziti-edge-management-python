...
class DetailSpecEnvelope(BaseModel):
    """
    DetailSpecEnvelope
    """
    data: SpecDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailSpecEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailSpecEnvelope:
        """Create an instance of DetailSpecEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailSpecEnvelope.parse_obj(obj)

        _obj = DetailSpecEnvelope.parse_obj({
            "data": SpecDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
