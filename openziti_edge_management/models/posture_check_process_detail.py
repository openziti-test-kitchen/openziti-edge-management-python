...
class PostureCheckProcessDetail(PostureCheckDetail):
    """
    PostureCheckProcessDetail
    """
    process: Process = Field(...)
    __properties = ["_links", "createdAt", "id", "name", "roleAttributes", "tags", "typeId", "updatedAt", "version", "process"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckProcessDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckProcessDetail:
        """Create an instance of PostureCheckProcessDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckProcessDetail.parse_obj(obj)

        _obj = PostureCheckProcessDetail.parse_obj({
            "links": dict(
