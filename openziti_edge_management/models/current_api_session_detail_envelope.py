...
class CurrentApiSessionDetailEnvelope(BaseModel):
    """
    CurrentApiSessionDetailEnvelope
    """
    data: CurrentApiSessionDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrentApiSessionDetailEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrentApiSessionDetailEnvelope:
        """Create an instance of CurrentApiSessionDetailEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurrentApiSessionDetailEnvelope.parse_obj(obj)

        _obj = CurrentApiSessionDetailEnvelope.parse_obj({
            "data": CurrentApiSessionDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
