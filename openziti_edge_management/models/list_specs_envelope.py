...
class ListSpecsEnvelope(BaseModel):
    """
    ListSpecsEnvelope
    """
    data: conlist(SpecDetail) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSpecsEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSpecsEnvelope:
        """Create an instance of ListSpecsEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSpecsEnvelope.parse_obj(obj)

        _obj = ListSpecsEnvelope.parse_obj({
            "data": [SpecDetail.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
