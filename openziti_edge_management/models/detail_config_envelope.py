...
class DetailConfigEnvelope(BaseModel):
    """
    DetailConfigEnvelope
    """
    data: ConfigDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailConfigEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailConfigEnvelope:
        """Create an instance of DetailConfigEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailConfigEnvelope.parse_obj(obj)

        _obj = DetailConfigEnvelope.parse_obj({
            "data": ConfigDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
