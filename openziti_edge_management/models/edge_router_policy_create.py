...
class EdgeRouterPolicyCreate(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EdgeRouterPolicyCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EdgeRouterPolicyCreate:
        """Create an instance of EdgeRouterPolicyCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EdgeRouterPolicyCreate.parse_obj(obj)

        _obj = EdgeRouterPolicyCreate.parse_obj({
