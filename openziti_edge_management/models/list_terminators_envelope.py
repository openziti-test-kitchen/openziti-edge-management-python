...
class ListTerminatorsEnvelope(BaseModel):
    """
    ListTerminatorsEnvelope
    """
    data: conlist(TerminatorDetail) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListTerminatorsEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListTerminatorsEnvelope:
        """Create an instance of ListTerminatorsEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListTerminatorsEnvelope.parse_obj(obj)

        _obj = ListTerminatorsEnvelope.parse_obj({
            "data": [TerminatorDetail.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
