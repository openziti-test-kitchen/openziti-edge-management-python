...
class DetailConfigTypeEnvelope(BaseModel):
    """
    DetailConfigTypeEnvelope
    """
    data: ConfigTypeDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailConfigTypeEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailConfigTypeEnvelope:
        """Create an instance of DetailConfigTypeEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailConfigTypeEnvelope.parse_obj(obj)

        _obj = DetailConfigTypeEnvelope.parse_obj({
            "data": ConfigTypeDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
