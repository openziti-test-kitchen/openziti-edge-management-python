...
class PostureCheckDomainPatch(PostureCheckPatch):
    """
    PostureCheckDomainPatch
    """
    domains: Optional[conlist(StrictStr, min_items=1)] = None
    __properties = ["name", "roleAttributes", "tags", "typeId", "domains"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckDomainPatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckDomainPatch:
        """Create an instance of PostureCheckDomainPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckDomainPatch.parse_obj(obj)

        _obj = PostureCheckDomainPatch.parse_obj({
            "name": obj.get("name"),
