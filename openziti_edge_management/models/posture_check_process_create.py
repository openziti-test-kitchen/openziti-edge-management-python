...
class PostureCheckProcessCreate(PostureCheckCreate):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckProcessCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckProcessCreate:
        """Create an instance of PostureCheckProcessCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckProcessCreate.parse_obj(obj)

        _obj = PostureCheckProcessCreate.parse_obj({
            "name": obj.get("name"),
