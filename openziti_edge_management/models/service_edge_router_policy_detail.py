...
class ServiceEdgeRouterPolicyDetail(BaseModel):
    """
    ...
    __properties = ["_links", "createdAt", "id", "tags", "updatedAt", "edgeRouterRoles", "edgeRouterRolesDisplay", "name", "semantic", "serviceRoles", "serviceRolesDisplay"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceEdgeRouterPolicyDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceEdgeRouterPolicyDetail:
        """Create an instance of ServiceEdgeRouterPolicyDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceEdgeRouterPolicyDetail.parse_obj(obj)

        _obj = ServiceEdgeRouterPolicyDetail.parse_obj({
            "links": dict(
