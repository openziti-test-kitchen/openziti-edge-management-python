...
class DetailMfaEnvelope(BaseModel):
    """
    DetailMfaEnvelope
    """
    data: DetailMfa = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailMfaEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailMfaEnvelope:
        """Create an instance of DetailMfaEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailMfaEnvelope.parse_obj(obj)

        _obj = DetailMfaEnvelope.parse_obj({
            "data": DetailMfa.from_dict(obj.get("data")) if obj.get("data") is not None else None,
