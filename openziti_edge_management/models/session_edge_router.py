...
class SessionEdgeRouter(BaseModel):
    ...
    urls: Dict[str, StrictStr] = Field(...)
    __properties = ["appData", "cost", "disabled", "hostname", "isOnline", "name", "noTraversal", "supportedProtocols", "syncStatus", "urls"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SessionEdgeRouter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SessionEdgeRouter:
        """Create an instance of SessionEdgeRouter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SessionEdgeRouter.parse_obj(obj)

        _obj = SessionEdgeRouter.parse_obj({
