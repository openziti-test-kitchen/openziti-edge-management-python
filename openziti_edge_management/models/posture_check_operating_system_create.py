...
class PostureCheckOperatingSystemCreate(PostureCheckCreate):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckOperatingSystemCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckOperatingSystemCreate:
        """Create an instance of PostureCheckOperatingSystemCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckOperatingSystemCreate.parse_obj(obj)

        _obj = PostureCheckOperatingSystemCreate.parse_obj({
            "name": obj.get("name"),
