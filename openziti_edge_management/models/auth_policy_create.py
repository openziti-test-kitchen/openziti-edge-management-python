...
class AuthPolicyCreate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthPolicyCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthPolicyCreate:
        """Create an instance of AuthPolicyCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthPolicyCreate.parse_obj(obj)

        _obj = AuthPolicyCreate.parse_obj({
            "name": obj.get("name"),
