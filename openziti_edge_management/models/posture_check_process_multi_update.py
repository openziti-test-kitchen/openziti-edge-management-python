...
class PostureCheckProcessMultiUpdate(PostureCheckUpdate):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckProcessMultiUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckProcessMultiUpdate:
        """Create an instance of PostureCheckProcessMultiUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckProcessMultiUpdate.parse_obj(obj)

        _obj = PostureCheckProcessMultiUpdate.parse_obj({
            "name": obj.get("name"),
