...
class DataIntegrityCheckResultEnvelope(BaseModel):
    """
    DataIntegrityCheckResultEnvelope
    """
    data: DataIntegrityCheckDetails = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataIntegrityCheckResultEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataIntegrityCheckResultEnvelope:
        """Create an instance of DataIntegrityCheckResultEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataIntegrityCheckResultEnvelope.parse_obj(obj)

        _obj = DataIntegrityCheckResultEnvelope.parse_obj({
            "data": DataIntegrityCheckDetails.from_dict(obj.get("data")) if obj.get("data") is not None else None,
