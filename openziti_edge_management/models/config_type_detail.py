...
class ConfigTypeDetail(BaseModel):
    ...
    var_schema: Dict[str, Any] = Field(..., alias="schema", description="A JSON schema to enforce configuration against")
    __properties = ["_links", "createdAt", "id", "tags", "updatedAt", "name", "schema"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConfigTypeDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConfigTypeDetail:
        """Create an instance of ConfigTypeDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConfigTypeDetail.parse_obj(obj)

        _obj = ConfigTypeDetail.parse_obj({
            "links": dict(
