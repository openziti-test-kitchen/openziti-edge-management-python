...
class ServiceEdgeRouterPolicyPatch(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceEdgeRouterPolicyPatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceEdgeRouterPolicyPatch:
        """Create an instance of ServiceEdgeRouterPolicyPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceEdgeRouterPolicyPatch.parse_obj(obj)

        _obj = ServiceEdgeRouterPolicyPatch.parse_obj({
