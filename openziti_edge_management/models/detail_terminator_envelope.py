...
class DetailTerminatorEnvelope(BaseModel):
    """
    DetailTerminatorEnvelope
    """
    data: TerminatorDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailTerminatorEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailTerminatorEnvelope:
        """Create an instance of DetailTerminatorEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailTerminatorEnvelope.parse_obj(obj)

        _obj = DetailTerminatorEnvelope.parse_obj({
            "data": TerminatorDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
