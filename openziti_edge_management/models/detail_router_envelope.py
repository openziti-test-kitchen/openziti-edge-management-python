...
class DetailRouterEnvelope(BaseModel):
    """
    DetailRouterEnvelope
    """
    data: RouterDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailRouterEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailRouterEnvelope:
        """Create an instance of DetailRouterEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailRouterEnvelope.parse_obj(obj)

        _obj = DetailRouterEnvelope.parse_obj({
            "data": RouterDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
