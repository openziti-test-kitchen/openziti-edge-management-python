...
class TerminatorPatch(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TerminatorPatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TerminatorPatch:
        """Create an instance of TerminatorPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TerminatorPatch.parse_obj(obj)

        _obj = TerminatorPatch.parse_obj({
