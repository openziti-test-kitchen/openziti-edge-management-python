...
class PostureCheckTypeDetail(BaseModel):
    """
    ...
    __properties = ["_links", "createdAt", "id", "tags", "updatedAt", "name", "operatingSystems", "version"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckTypeDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckTypeDetail:
        """Create an instance of PostureCheckTypeDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckTypeDetail.parse_obj(obj)

        _obj = PostureCheckTypeDetail.parse_obj({
            "links": dict(
