...
class DetailServiceEnvelope(BaseModel):
    """
    DetailServiceEnvelope
    """
    data: ServiceDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailServiceEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailServiceEnvelope:
        """Create an instance of DetailServiceEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailServiceEnvelope.parse_obj(obj)

        _obj = DetailServiceEnvelope.parse_obj({
            "data": ServiceDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
