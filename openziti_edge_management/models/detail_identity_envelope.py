...
class DetailIdentityEnvelope(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailIdentityEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailIdentityEnvelope:
        """Create an instance of DetailIdentityEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailIdentityEnvelope.parse_obj(obj)

        _obj = DetailIdentityEnvelope.parse_obj({
