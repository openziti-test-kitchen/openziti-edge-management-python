...
class AuthenticatorPatchWithCurrent(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthenticatorPatchWithCurrent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthenticatorPatchWithCurrent:
        """Create an instance of AuthenticatorPatchWithCurrent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthenticatorPatchWithCurrent.parse_obj(obj)

        _obj = AuthenticatorPatchWithCurrent.parse_obj({
