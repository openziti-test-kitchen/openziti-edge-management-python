...
class AuthPolicyDetail(BaseModel):
    """
    ...
    primary: AuthPolicyPrimary = Field(...)
    secondary: AuthPolicySecondary = Field(...)
    __properties = ["_links", "createdAt", "id", "tags", "updatedAt", "name", "primary", "secondary"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthPolicyDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthPolicyDetail:
        """Create an instance of AuthPolicyDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthPolicyDetail.parse_obj(obj)

        _obj = AuthPolicyDetail.parse_obj({
            "links": dict(
            ...
            "name": obj.get("name"),
            "primary": AuthPolicyPrimary.from_dict(obj.get("primary")) if obj.get("primary") is not None else None,
            "secondary": AuthPolicySecondary.from_dict(obj.get("secondary")) if obj.get("secondary") is not None else None
        })
        return _obj
