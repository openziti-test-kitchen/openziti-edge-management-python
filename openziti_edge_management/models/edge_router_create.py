...
class EdgeRouterCreate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EdgeRouterCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EdgeRouterCreate:
        """Create an instance of EdgeRouterCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EdgeRouterCreate.parse_obj(obj)

        _obj = EdgeRouterCreate.parse_obj({
