...
class DetailMfa(BaseModel):
    ...
    provisioning_url: Optional[StrictStr] = Field(None, alias="provisioningUrl", description="Not provided if MFA verification has been completed")
    recovery_codes: Optional[conlist(StrictStr)] = Field(None, alias="recoveryCodes", description="Not provided if MFA verification has been completed")
    __properties = ["_links", "createdAt", "id", "tags", "updatedAt", "isVerified", "provisioningUrl", "recoveryCodes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailMfa:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailMfa:
        """Create an instance of DetailMfa from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailMfa.parse_obj(obj)

        _obj = DetailMfa.parse_obj({
            "links": dict(
            ...
            "provisioning_url": obj.get("provisioningUrl"),
