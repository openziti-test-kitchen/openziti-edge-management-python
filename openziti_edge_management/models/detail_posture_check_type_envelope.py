...
class DetailPostureCheckTypeEnvelope(BaseModel):
    """
    DetailPostureCheckTypeEnvelope
    """
    data: PostureCheckTypeDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailPostureCheckTypeEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailPostureCheckTypeEnvelope:
        """Create an instance of DetailPostureCheckTypeEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailPostureCheckTypeEnvelope.parse_obj(obj)

        _obj = DetailPostureCheckTypeEnvelope.parse_obj({
            "data": PostureCheckTypeDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
