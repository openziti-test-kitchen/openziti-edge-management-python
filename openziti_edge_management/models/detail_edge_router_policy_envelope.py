...
class DetailEdgeRouterPolicyEnvelope(BaseModel):
    """
    DetailEdgeRouterPolicyEnvelope
    """
    data: EdgeRouterPolicyDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailEdgeRouterPolicyEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailEdgeRouterPolicyEnvelope:
        """Create an instance of DetailEdgeRouterPolicyEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailEdgeRouterPolicyEnvelope.parse_obj(obj)

        _obj = DetailEdgeRouterPolicyEnvelope.parse_obj({
            "data": EdgeRouterPolicyDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
