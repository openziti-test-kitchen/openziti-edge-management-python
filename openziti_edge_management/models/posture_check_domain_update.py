...
class PostureCheckDomainUpdate(PostureCheckUpdate):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckDomainUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckDomainUpdate:
        """Create an instance of PostureCheckDomainUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckDomainUpdate.parse_obj(obj)

        _obj = PostureCheckDomainUpdate.parse_obj({
            "name": obj.get("name"),
