...
class DetailAuthenticatorEnvelope(BaseModel):
    """
    DetailAuthenticatorEnvelope
    """
    data: AuthenticatorDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailAuthenticatorEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailAuthenticatorEnvelope:
        """Create an instance of DetailAuthenticatorEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailAuthenticatorEnvelope.parse_obj(obj)

        _obj = DetailAuthenticatorEnvelope.parse_obj({
            "data": AuthenticatorDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
