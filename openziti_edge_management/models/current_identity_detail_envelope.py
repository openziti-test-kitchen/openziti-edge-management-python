...
class CurrentIdentityDetailEnvelope(BaseModel):
    """
    CurrentIdentityDetailEnvelope
    """
    data: IdentityDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrentIdentityDetailEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrentIdentityDetailEnvelope:
        """Create an instance of CurrentIdentityDetailEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurrentIdentityDetailEnvelope.parse_obj(obj)

        _obj = CurrentIdentityDetailEnvelope.parse_obj({
            "data": IdentityDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
