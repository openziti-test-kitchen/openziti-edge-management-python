...
class PostureCheckDomainDetail(PostureCheckDetail):
    """
    PostureCheckDomainDetail
    """
    domains: conlist(StrictStr, min_items=1) = Field(...)
    __properties = ["_links", "createdAt", "id", "name", "roleAttributes", "tags", "typeId", "updatedAt", "version", "domains"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckDomainDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckDomainDetail:
        """Create an instance of PostureCheckDomainDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckDomainDetail.parse_obj(obj)

        _obj = PostureCheckDomainDetail.parse_obj({
            "links": dict(
