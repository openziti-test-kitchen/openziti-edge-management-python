...
class PostureCheckProcessMultiDetail(PostureCheckDetail):
    """
    PostureCheckProcessMultiDetail
    """
    processes: conlist(ProcessMulti, min_items=1) = Field(...)
    semantic: Semantic = Field(...)
    __properties = ["_links", "createdAt", "id", "name", "roleAttributes", "tags", "typeId", "updatedAt", "version", "processes", "semantic"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckProcessMultiDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckProcessMultiDetail:
        """Create an instance of PostureCheckProcessMultiDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckProcessMultiDetail.parse_obj(obj)

        _obj = PostureCheckProcessMultiDetail.parse_obj({
            "links": dict(
