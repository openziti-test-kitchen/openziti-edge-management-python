...
class GetIdentityPolicyAdviceEnvelope(BaseModel):
    """
    GetIdentityPolicyAdviceEnvelope
    """
    data: PolicyAdvice = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetIdentityPolicyAdviceEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetIdentityPolicyAdviceEnvelope:
        """Create an instance of GetIdentityPolicyAdviceEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetIdentityPolicyAdviceEnvelope.parse_obj(obj)

        _obj = GetIdentityPolicyAdviceEnvelope.parse_obj({
            "data": PolicyAdvice.from_dict(obj.get("data")) if obj.get("data") is not None else None,
