...
class DetailSpecBodyEnvelope(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailSpecBodyEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailSpecBodyEnvelope:
        """Create an instance of DetailSpecBodyEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailSpecBodyEnvelope.parse_obj(obj)

        _obj = DetailSpecBodyEnvelope.parse_obj({
            "data": obj.get("data"),
