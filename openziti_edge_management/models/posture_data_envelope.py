...
class PostureDataEnvelope(BaseModel):
    """
    PostureDataEnvelope
    """
    data: PostureData = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureDataEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureDataEnvelope:
        """Create an instance of PostureDataEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureDataEnvelope.parse_obj(obj)

        _obj = PostureDataEnvelope.parse_obj({
            "data": PostureData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
