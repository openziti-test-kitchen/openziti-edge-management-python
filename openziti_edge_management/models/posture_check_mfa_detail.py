...
class PostureCheckMfaDetail(PostureCheckDetail):
    """
    ...
    __properties = ["_links", "createdAt", "id", "name", "roleAttributes", "tags", "typeId", "updatedAt", "version", "ignoreLegacyEndpoints", "promptOnUnlock", "promptOnWake", "timeoutSeconds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckMfaDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckMfaDetail:
        """Create an instance of PostureCheckMfaDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckMfaDetail.parse_obj(obj)

        _obj = PostureCheckMfaDetail.parse_obj({
            "links": dict(
