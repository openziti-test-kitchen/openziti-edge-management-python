...
class DetailExternalJwtSignerEnvelope(BaseModel):
    """
    DetailExternalJwtSignerEnvelope
    """
    data: ExternalJwtSignerDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailExternalJwtSignerEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailExternalJwtSignerEnvelope:
        """Create an instance of DetailExternalJwtSignerEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailExternalJwtSignerEnvelope.parse_obj(obj)

        _obj = DetailExternalJwtSignerEnvelope.parse_obj({
            "data": ExternalJwtSignerDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
