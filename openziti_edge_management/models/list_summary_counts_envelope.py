...
class ListSummaryCountsEnvelope(BaseModel):
    """
    ListSummaryCountsEnvelope
    """
    data: Dict[str, StrictInt] = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListSummaryCountsEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListSummaryCountsEnvelope:
        """Create an instance of ListSummaryCountsEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListSummaryCountsEnvelope.parse_obj(obj)

        _obj = ListSummaryCountsEnvelope.parse_obj({
            "data": obj.get("data"),
