...
class PostureCheckOperatingSystemPatch(PostureCheckPatch):
    """
    PostureCheckOperatingSystemPatch
    """
    operating_systems: Optional[conlist(OperatingSystem, min_items=1)] = Field(None, alias="operatingSystems")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckOperatingSystemPatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckOperatingSystemPatch:
        """Create an instance of PostureCheckOperatingSystemPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckOperatingSystemPatch.parse_obj(obj)

        _obj = PostureCheckOperatingSystemPatch.parse_obj({
            "name": obj.get("name"),
