...
class ListIdentityTypesEnvelope(BaseModel):
    """
    ListIdentityTypesEnvelope
    """
    data: conlist(IdentityTypeDetail) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListIdentityTypesEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListIdentityTypesEnvelope:
        """Create an instance of ListIdentityTypesEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListIdentityTypesEnvelope.parse_obj(obj)

        _obj = ListIdentityTypesEnvelope.parse_obj({
            "data": [IdentityTypeDetail.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
