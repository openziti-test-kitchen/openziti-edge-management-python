...
class DetailServiceEdgePolicyEnvelope(BaseModel):
    """
    DetailServiceEdgePolicyEnvelope
    """
    data: ServiceEdgeRouterPolicyDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailServiceEdgePolicyEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailServiceEdgePolicyEnvelope:
        """Create an instance of DetailServiceEdgePolicyEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailServiceEdgePolicyEnvelope.parse_obj(obj)

        _obj = DetailServiceEdgePolicyEnvelope.parse_obj({
            "data": ServiceEdgeRouterPolicyDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
