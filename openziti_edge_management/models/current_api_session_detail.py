...
class CurrentApiSessionDetail(BaseModel):
    """
    ...
    expiration_seconds: StrictInt = Field(..., alias="expirationSeconds")
    expires_at: datetime = Field(..., alias="expiresAt")
    __properties = ["_links", "createdAt", "id", "tags", "updatedAt", "authQueries", "authenticatorId", "cachedLastActivityAt", "configTypes", "identity", "identityId", "ipAddress", "isMfaComplete", "isMfaRequired", "lastActivityAt", "token", "expirationSeconds", "expiresAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CurrentApiSessionDetail:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CurrentApiSessionDetail:
        """Create an instance of CurrentApiSessionDetail from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CurrentApiSessionDetail.parse_obj(obj)

        _obj = CurrentApiSessionDetail.parse_obj({
            "links": dict(
