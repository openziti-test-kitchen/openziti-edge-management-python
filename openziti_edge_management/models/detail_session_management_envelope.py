...
class DetailSessionManagementEnvelope(BaseModel):
    """
    DetailSessionManagementEnvelope
    """
    data: SessionManagementDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailSessionManagementEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailSessionManagementEnvelope:
        """Create an instance of DetailSessionManagementEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailSessionManagementEnvelope.parse_obj(obj)

        _obj = DetailSessionManagementEnvelope.parse_obj({
            "data": SessionManagementDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
