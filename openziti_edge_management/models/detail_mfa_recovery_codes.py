...
class DetailMfaRecoveryCodes(BaseModel):
    """
    ...
    recovery_codes: conlist(StrictStr) = Field(..., alias="recoveryCodes")
    __properties = ["_links", "createdAt", "id", "tags", "updatedAt", "recoveryCodes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailMfaRecoveryCodes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailMfaRecoveryCodes:
        """Create an instance of DetailMfaRecoveryCodes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailMfaRecoveryCodes.parse_obj(obj)

        _obj = DetailMfaRecoveryCodes.parse_obj({
            "links": dict(
