...
class CreateEnvelope(BaseModel):
    ...
    CreateEnvelope
    """
    data: Optional[CreateLocation] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateEnvelope:
        """Create an instance of CreateEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateEnvelope.parse_obj(obj)

        _obj = CreateEnvelope.parse_obj({
            "data": CreateLocation.from_dict(obj.get("data")) if obj.get("data") is not None else None,
