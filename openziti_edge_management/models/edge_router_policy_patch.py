...
class EdgeRouterPolicyPatch(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EdgeRouterPolicyPatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EdgeRouterPolicyPatch:
        """Create an instance of EdgeRouterPolicyPatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EdgeRouterPolicyPatch.parse_obj(obj)

        _obj = EdgeRouterPolicyPatch.parse_obj({
