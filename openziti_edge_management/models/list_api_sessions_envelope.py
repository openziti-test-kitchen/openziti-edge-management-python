...
class ListApiSessionsEnvelope(BaseModel):
    """
    ListApiSessionsEnvelope
    """
    data: conlist(ApiSessionDetail) = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListApiSessionsEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListApiSessionsEnvelope:
        """Create an instance of ListApiSessionsEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListApiSessionsEnvelope.parse_obj(obj)

        _obj = ListApiSessionsEnvelope.parse_obj({
            "data": [ApiSessionDetail.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
