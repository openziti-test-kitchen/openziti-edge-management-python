...
class PostureCheckDomainCreate(PostureCheckCreate):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostureCheckDomainCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostureCheckDomainCreate:
        """Create an instance of PostureCheckDomainCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostureCheckDomainCreate.parse_obj(obj)

        _obj = PostureCheckDomainCreate.parse_obj({
            "name": obj.get("name"),
