...
class DetailIdentityTypeEnvelope(BaseModel):
    """
    DetailIdentityTypeEnvelope
    """
    data: IdentityTypeDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailIdentityTypeEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailIdentityTypeEnvelope:
        """Create an instance of DetailIdentityTypeEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailIdentityTypeEnvelope.parse_obj(obj)

        _obj = DetailIdentityTypeEnvelope.parse_obj({
            "data": IdentityTypeDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
