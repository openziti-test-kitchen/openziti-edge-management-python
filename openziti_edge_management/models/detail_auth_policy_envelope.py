...
class DetailAuthPolicyEnvelope(BaseModel):
    """
    DetailAuthPolicyEnvelope
    """
    data: AuthPolicyDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailAuthPolicyEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailAuthPolicyEnvelope:
        """Create an instance of DetailAuthPolicyEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailAuthPolicyEnvelope.parse_obj(obj)

        _obj = DetailAuthPolicyEnvelope.parse_obj({
            "data": AuthPolicyDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
