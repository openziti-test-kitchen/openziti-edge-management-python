...
class ExternalJwtSignerUpdate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalJwtSignerUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalJwtSignerUpdate:
        """Create an instance of ExternalJwtSignerUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalJwtSignerUpdate.parse_obj(obj)

        _obj = ExternalJwtSignerUpdate.parse_obj({
