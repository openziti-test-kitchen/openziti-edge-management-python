...
class DetailSessionRoutePathEnvelope(BaseModel):
    """
    DetailSessionRoutePathEnvelope
    """
    data: SessionRoutePathDetail = Field(...)
    meta: Meta = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DetailSessionRoutePathEnvelope:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DetailSessionRoutePathEnvelope:
        """Create an instance of DetailSessionRoutePathEnvelope from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DetailSessionRoutePathEnvelope.parse_obj(obj)

        _obj = DetailSessionRoutePathEnvelope.parse_obj({
            "data": SessionRoutePathDetail.from_dict(obj.get("data")) if obj.get("data") is not None else None,
