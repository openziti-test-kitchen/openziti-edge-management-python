...
class PostureCheckCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, type_id, *args, **kwargs):  # noqa: E501
        """PostureCheckCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, type_id, *args, **kwargs):  # noqa: E501
        """PostureCheckCreate - a model defined in OpenAPI
