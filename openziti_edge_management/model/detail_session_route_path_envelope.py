...
class DetailSessionRoutePathEnvelope(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (SessionRoutePathDetail,),  # noqa: E501
            'meta': (Meta,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, meta, *args, **kwargs):  # noqa: E501
        """DetailSessionRoutePathEnvelope - a model defined in OpenAPI

        Args:
            data (SessionRoutePathDetail):
            meta (Meta):
