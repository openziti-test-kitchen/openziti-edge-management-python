...
class DetailPostureCheckEnvelope(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (PostureCheckDetail,),  # noqa: E501
            'meta': (Meta,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, meta, *args, **kwargs):  # noqa: E501
        """DetailPostureCheckEnvelope - a model defined in OpenAPI

        Args:
            data (PostureCheckDetail):
            meta (Meta):
