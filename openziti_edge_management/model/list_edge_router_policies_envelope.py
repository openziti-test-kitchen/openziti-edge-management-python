...
class ListEdgeRouterPoliciesEnvelope(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (EdgeRouterPolicyList,),  # noqa: E501
            'meta': (Meta,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, meta, *args, **kwargs):  # noqa: E501
        """ListEdgeRouterPoliciesEnvelope - a model defined in OpenAPI

        Args:
            data (EdgeRouterPolicyList):
            meta (Meta):
