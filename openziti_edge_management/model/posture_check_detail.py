...
class PostureCheckDetail(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, links, created_at, id, name, role_attributes, tags, type_id, updated_at, version, *args, **kwargs):  # noqa: E501
        """PostureCheckDetail - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, links, created_at, id, name, role_attributes, tags, type_id, updated_at, version, *args, **kwargs):  # noqa: E501
        """PostureCheckDetail - a model defined in OpenAPI
