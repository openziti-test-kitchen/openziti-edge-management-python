...
class VersionInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, arch, build_date, os, revision, version, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, arch, build_date, os, revision, version, *args, **kwargs):  # noqa: E501
        """VersionInfo - a model defined in OpenAPI
