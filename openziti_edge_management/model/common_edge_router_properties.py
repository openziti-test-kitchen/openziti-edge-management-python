...
class CommonEdgeRouterProperties(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cost, hostname, is_online, name, no_traversal, supported_protocols, sync_status, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, cost, hostname, is_online, name, no_traversal, supported_protocols, sync_status, *args, **kwargs):  # noqa: E501
        """CommonEdgeRouterProperties - a model defined in OpenAPI
