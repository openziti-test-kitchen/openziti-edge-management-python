...
class ListServiceEdgeRouterPoliciesEnvelope(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (ServiceEdgeRouterPolicyList,),  # noqa: E501
            'meta': (Meta,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, meta, *args, **kwargs):  # noqa: E501
        """ListServiceEdgeRouterPoliciesEnvelope - a model defined in OpenAPI

        Args:
            data (ServiceEdgeRouterPolicyList):
            meta (Meta):
