...
class ConfigCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, config_type_id, data, name, *args, **kwargs):  # noqa: E501
        """ConfigCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, config_type_id, data, name, *args, **kwargs):  # noqa: E501
        """ConfigCreate - a model defined in OpenAPI
