...
class ServiceDetailAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, config, configs, encryption_required, name, permissions, posture_queries, role_attributes, terminator_strategy, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, config, configs, encryption_required, name, permissions, posture_queries, role_attributes, terminator_strategy, *args, **kwargs):  # noqa: E501
        """ServiceDetailAllOf - a model defined in OpenAPI
