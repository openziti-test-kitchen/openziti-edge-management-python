...
from openziti_edge_management import rest
from openziti_edge_management.configuration import Configuration
from openziti_edge_management.exceptions import ApiTypeError, ApiValueError, ApiException
from openziti_edge_management.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/0.26.46/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = APISessionApi()
        api_instance.delete_api_sessions  # this is an instance of the class Endpoint
        api_instance.delete_api_sessions()  # this invokes api_instance.delete_api_sessions.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.delete_api_sessions.callable or self.callable in this class
